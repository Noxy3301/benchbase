...
public class TPCCUtil {
  ...
  public static Customer newCustomerFromResults(ResultSet rs) throws SQLException {
    ...
    // Uppercase labels: they match the SELECT lists in the procedure SQL, which is
    // what case-sensitive drivers (Tsurugi) return; MySQL/Postgres are label-case-insensitive.
